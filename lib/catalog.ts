...
export const STYLE_OPTIONS=[
  ['Modern','Clean · architectural · calm','https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=900&q=80','clean architectural lines, low-profile furniture, restrained neutral palette, glass, stone and matte black accents; current but not ornate'],
  ...
  ['Coastal','Airy · soft · relaxed','https://images.unsplash.com/photo-1600607688969-a5bfcd646154?auto=format&fit=crop&w=900&q=80','refined coastal interior, airy white and sand palette, washed wood, linen slipcovers, subtle blue accents and natural woven textures; no beach-theme kitsch'],
  ...
  ['Mid-Century Modern','Sculptural · warm wood · iconic','https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=900&q=80','1950s–60s modernism: walnut casegoods, tapered legs, iconic sculptural seating, globe lamps, graphic art and olive, rust or mustard accents'],
  ...
  ['Cottagecore','Charming · floral · nostalgic','https://images.unsplash.com/photo-1600566753051-f0b89df2dd90?auto=format&fit=crop&w=900&q=80','romantic English-country cottage: small floral prints, painted vintage furniture, warm timber, gathered linen, baskets, ceramics and garden flowers'],
] as const;
